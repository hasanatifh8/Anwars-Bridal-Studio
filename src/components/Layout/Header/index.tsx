...
const Header: React.FC = () => {
  ...
  return (
    <>
      ...
      <header
        className={`fixed h-28 top-0 py-1 z-50 w-full bg-transparent transition-all  ${
        ...
        <div className="container">
          <div className="flex items-center justify-between py-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              >
                <span className="!py-2 !px-4">Book Appointment</span>
              </Link>
              <button
        ...
        >
          ...
          <nav className="flex flex-col items-start p-4">
            ...
            <div className="mt-4 flex flex-col space-y-4 w-full">
              <Link
                href="/contact"
                className="bg-primary text-white text-center px-4 py-2 rounded-lg hover:bg-RegalBlue"
                onClick={() => setNavbarOpen(false)}
              >
                Book Appointment
              </Link>
