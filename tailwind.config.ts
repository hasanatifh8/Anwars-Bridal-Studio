  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        PaleCyan: "#F0E6C8",
        Aquamarine: "#EAD9A0",
        MidnightNavyText: "#1A1613",
        SlateBlueText : "#6B6355",
        PaleSkyBlu: "#F1E8CF",
        MistyTealText: "#8A7F68",
        OliveDrab: "#73713C",
        CadetBlue: "#B3A98C",
        Dandelion: "#F2EC1D",
        SkyBlueMist: "#EADFC0",
        ...
        YellowRating: "#D4AF37",
        PaleCerulean: "#C9BFA6",
        PeriwinkleBorder:"#D9C88F",
        LightBlueBorder: "#C9A227",
        OceanDepthsDarkBorder: "#3A2F1A",
        PowderBlueBorder: "#EFE8D6",
        darkLineColor: "#3A2F1A",
        darkmode: "#0B0B0A",
        darklight: "#171512",
        darktext: "#B8AF9C",
        dark_border: "#33291A",
